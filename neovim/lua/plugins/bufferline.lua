...
local setup = {
  ...
  options = {
    ...
    indicator = {
      icon = hvim.icons.ui.BoldLineLeft, -- this should be omitted if indicator style is not 'icon'
      style = "icon", -- can also be 'underline'|'none',
    },
    buffer_close_icon = hvim.icons.ui.Close,
    modified_icon = hvim.icons.ui.Circle,
    close_icon = hvim.icons.ui.BoldClose,
    left_trunc_marker = hvim.icons.ui.ArrowCircleLeft,
    right_trunc_marker = hvim.icons.ui.ArrowCircleRight,
    ...
    show_buffer_icons = hvim.use_icons, -- disable filetype icons for buffers
    show_buffer_close_icons = hvim.use_icons,
...
vim.keymap.set("n", "<leader>bd", ":bd<CR>", expr_opts)
vim.keymap.set("n", "<leader>bp", ":BufferLinePick<CR>", expr_opts)
